    ...
    for epoch in range(epochs):
        ...
        for e in range(local_epoch):
            ...
            for idx, worker in enumerate(workers):
                ...
                worker_output = global_train_outputs[idx]
                # worker_target = train_targets[start_idx:end_idx]
                # worker_output = train_outputs[start_idx:end_idx]
            ...
            epoch_losses.append(e_avg_loss)
            epoch_acc.append(e_avg_acc)
            print("第{}轮：第{}小轮：Train_Avg_loss:{},Train_Avg_acc:{}".format((epoch+1),(e+1),e_avg_loss,e_avg_acc))
        ...
        print("第{}轮：Train_Avg_loss:{},Train_Avg_acc:{}".format((epoch+1),(e+1),sum(epoch_losses)/len(epoch_losses),sum(epoch_acc)/len(epoch_acc)))
        with open("results/cifar10/train5010_os_sp1_loss_acc.txt", "a") as f:
            f.write(f"{epoch+1}\t{e+1}\t{sum(epoch_losses)/len(epoch_losses)}\t{sum(epoch_acc)/len(epoch_acc)}\n")
        ...
        print("第{}轮：Test Loss: {}，Test Accuracy: {}".format((epoch+1),test_avg_loss,test_avg_acc))

        print("第{}轮：第{}小轮：用时：{}s".format((epoch+1),(e+1),(time.time()-e_time)))
        with open("results/cifar10/test5010_os_sp1_loss_acc.txt", "a") as f:
