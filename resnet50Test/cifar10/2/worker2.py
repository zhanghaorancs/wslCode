...
def worker_train_one_epoch(batch_idx):
    ...
    global worker_model, worker_optimizer, worker_criterion, train_dataloader, train_loader_iter,train_outputs,test_dataloader
    worker_model.train()
    ...
    return train_outputs.cpu(), targets.cpu()
...
def worker_test_one_epoch(batch_idx):
    ...
    test_outputs = test_outputs.clone()

    return test_outputs.cpu(), targets.cpu()
