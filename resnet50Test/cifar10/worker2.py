...
data_path = "data/worker_data/cifar10/worker02"
train_data_path = "worker02_train_data.pkl"
test_data_path = "worker02_test_data.pkl"
...
if __name__ == '__main__':
    rpc.init_rpc("worker2",rank=2,world_size=5)
