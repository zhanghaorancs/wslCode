...
if __name__ == '__main__':
    ...
    # 通知worker初始化
    data_path = ["data/worker_data/mnist/worker01","data/worker_data/mnist/worker02",
                 "data/worker_data/mnist/worker03","data/worker_data/mnist/worker04"]
    ...
    for epoch in range(epochs):
        ...
        with open("results/mnist/train_resnet50_noAggregate_sp1_loss_accuracy.txt", "a") as f:
        ...
        with open("results/mnist/test_resnet50_noAggreagte_sp1_loss_acc.txt", "a") as f:
